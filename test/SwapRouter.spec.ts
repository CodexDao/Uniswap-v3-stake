...
import { IWETH9, MockTimeNonfungiblePositionManager, MockTimeSwapRouter, TestERC20, PairCreate } from '../typechain'
...
describe('SwapRouter', () => {
  ...
  const swapRouterFixture: Fixture<{
    ...
    const { weth9, factory, router, tokens, nft, pairCreate } = await completeFixture(wallets, provider)
  ...
  beforeEach('load fixture', async () => {
    ; ({ router, weth9, factory, tokens, nft, pairCreate } = await loadFixture(swapRouterFixture))
