...
import { IUniswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20, PairCreate } from '../typechain'
...
describe('SwapRouter gas tests', () => {
  ...
  const swapRouterFixture: Fixture<{
    ...
    const { weth9, factory, router, tokens, nft, luckManager, pairCreate } = await completeFixture(wallets, provider)
  ...
  beforeEach('load fixture', async () => {
    ; ({ router, weth9, tokens, pools, pairCreate } = await loadFixture(swapRouterFixture))
  })
